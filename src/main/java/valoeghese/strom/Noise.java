...
public class Noise extends NoiseGenerator {
	...
	public double sample(double x) {
		return 1.0/0.866 * super.sample(x + this.xOffset, 0.0);
	}

	@Override
	public double sample(double x, double y) {
		return 1.0/0.866 * super.sample(x + this.xOffset, y + this.yOffset);
	}
 ...
 */
@SuppressWarnings("all") // let the magic noisegen man do his magic
